...
@router.post("/")
async def create_sub_category(sub_category:SubCategoryBase):return await service.create(data=sub_category)
...
async def bulk_import_sub_categories(overwrite:bool,files:list[UploadFile]=File(...)):return await service.bulk_upload(overwrite,files)
@router.post("/export/")
